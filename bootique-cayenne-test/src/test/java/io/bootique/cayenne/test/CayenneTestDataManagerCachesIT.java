...
import io.bootique.cayenne.test.experiment.RefreshExtension;
...
public class CayenneTestDataManagerCachesIT {
    ...
    public static void getRuntime() {
        serverRuntime =  dataManagerExtension
                .getCayenneTestDataManager().getRuntime();
    }
    ...
    private void verifyCachesEmptyAndAddObjectsToCache() {
        ...
        assertEquals(0, serverRuntime.getDataDomain().getSharedSnapshotCache().size());
